$(function () {
    ...
    function echarts_6(data) {
        ...
        var option = {
            color: ['#0f63d6', '#A7D639', '#D6984A', '#70D62A', '#3FC1D6'],
            tooltip: {},
            legend: {
                // data: ["学历一", "学历二", "学历三", "学历四", "学历五"],
                top:'0%',
    ...
    function crawl_number(data) {
        document.getElementById("all").innerHTML = data['counter']['all_count']
        document.getElementById("today").innerHTML = data['counter']['today_count']
    }
});